...
public class StepView extends LinearLayout implements StepsViewIndicator.OnDrawIndicatorListener
{
    ...
    private String mUnComplectedTextColor = "#F8F8F8";//定义默认未完成文字的颜色;
    ...
    private void init()
    {
        View rootView = LayoutInflater.from(getContext()).inflate(R.layout.stepview_widget, this);
     ...
     * @return
     */
    public StepView setStepViewUnComplectedTextColor(String unComplectedTextColor)
    {
     ...
     * @return
     */
    public StepView setStepsViewIndicatorUnCompletedLineColor(String unCompletedLineColor)
    {
    ...
    public void ondrawIndicator()
    {
        ...
        if(mTexts != null)
        {
            for(int i = 0; i < mTexts.size(); i++)
            {
                ...
                {
                    textView.setTextColor(Color.parseColor(mUnComplectedTextColor));
                }
